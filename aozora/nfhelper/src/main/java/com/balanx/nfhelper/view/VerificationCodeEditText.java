...
public class VerificationCodeEditText extends android.support.v7.widget.AppCompatEditText implements
    ...
    private int mBottomFocusColor;//当中焦点的颜色
    ...
    private Paint mBottomFocusPaint;
    ...
    private void initPaint() {
        ...
        mBottomFocusPaint = new Paint();
        mBottomFocusPaint.setColor(mBottomFocusColor);
        mBottomFocusPaint.setStrokeWidth(mBottomLineHeight);
    }
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mBottomSelectedColor = ta.getColor(R.styleable.VerCodeEditText_bottomLineSelectedColor,
                getCurrentTextColor());
        mBottomFocusColor = ta.getColor(R.styleable.VerCodeEditText_bottomFocusColor, getCurrentTextColor());
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mFigures; i++) {
            ...
            if (i < mCurrentPosition) {
                ...
                canvas.drawLine(start, lineY, end, lineY, mBottomFocusPaint);
            } else {
