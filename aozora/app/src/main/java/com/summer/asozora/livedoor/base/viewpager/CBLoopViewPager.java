...
public class CBLoopViewPager extends ViewPager {
    ...
    private OnSimpleClickListener onItemClickListener;
                ...
                switch (ev.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (Math.abs(oldX - newX) < sens) {
                            onItemClickListener.onClick((getRealItem()));
                        }
                        oldX = 0;
                        newX = 0;
                        break;
    ...
    public void setOnItemClickListener(OnSimpleClickListener onItemClickListener) {
