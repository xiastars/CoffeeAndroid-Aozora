...
public class RoundAngleImageView extends ImageView {
	...
	public RoundAngleImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		if(backDrawable != null){
			backDrawable = RoundedDrawable.fromDrawable(backDrawable);
		}else{
			backDrawable = RoundedDrawable.fromDrawable(context.getResources().getDrawable(R.drawable.ic_launcher));
		}
	...
	public void setDefaultBackgroundColor(int color){
		Drawable backDrawable = RoundedDrawable.fromDrawable(context.getResources().getDrawable(color));
		( (RoundedDrawable) backDrawable).setScaleType(mScaleType)
		.setCornerRadius(cornerRadius).setBorderWidth(borderWidth)
		.setBorderColor(borderColor).setOval(isOval);
		setBackgroundDrawable(backDrawable);
