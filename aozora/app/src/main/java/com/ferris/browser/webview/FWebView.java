...
public class FWebView  extends TitleBarWebView {
	...
	public FWebView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void onActionUpOrCancel() {
		...
		if (oldTY * 2 > mMinTranslationY || scrollY < mTitleBarHeight){
			...
			startAnimation(mBottomBar, -mMaxTranslationY);
		}else{
